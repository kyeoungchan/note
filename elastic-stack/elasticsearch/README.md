...
> [!NOTE]
> Elasticsearch는 데이터를 저장할 때 문서 안의 텍스트를 **토큰(Token)** 으로 분리하고, 각 토큰이 어떤 문서에 존재하는지를 기록한 **역색인 테이블**을 만들어준다.  
> 이 과정을 Elasticsearch 역인덱싱 과정이라고 한다.  
> 
...
- [Elasticsearch 역색인이란? Inverted Index](https://sudo-minz.tistory.com/237)